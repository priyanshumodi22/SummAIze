...
const Demo = () => {
  ...
  return (
    <section className='mt-16 w-full max-w-4xl'>
      {/* search component */}
      <div className='flex flex-col w-full gap-2 dark:bg-slate-950'>
        ...
        >
          ...
          <input
            ...
            onChange={(e) => setArticle({ ...article, length: parseInt(e.target.value) })}
            required
        ...
        <div className='flex flex-col gap-1 max-h-60 overflow-y-scroll scrollbar'>
          {allArticles.map((item, index) => (
            <div
              ...
              className='link_card'
             >
              <div className='copy_btn' onClick={() => handleCopy_url(item.url)}>
                <img
            ...
            article.summary && (
              <div className='flex flex-col gap-3'>
                ...
                <div className='summary_box'>
                  <p>{article.summary}</p>
                  <div className='copy_btn' onClick={() => handleCopy_Summary(article.summary)}>
                    <img
